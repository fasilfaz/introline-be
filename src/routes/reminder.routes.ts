...
import { listReminders, getReminder, createReminder, updateReminder, deleteReminder, sendWhatsAppReminder } from '../controllers/reminder.controller';
...
// Send/resend WhatsApp reminder
router.post('/:id/send-whatsapp', [param('id').isMongoId()], validateRequest, sendWhatsAppReminder);
